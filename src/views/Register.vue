      ...
      <div class="flex w-3/4 h-3/4">
        ...
        >
          <div class="text-2xl text-center mb-3">
            <span class="text-2xl text-primary-500">Kiwikcms Sign up</span>
          </div>
          <div class="flex justify-between mx-auto w-3/2">
            <button
              type="button"
              class="text-primary-500 bg-action-500 hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-8 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
            >
              <svg
            ...
            <button
              type="button"
              class="text-white bg-primary-500 hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
            >
              <svg
                aria-hidden="true"
                focusable="false"
